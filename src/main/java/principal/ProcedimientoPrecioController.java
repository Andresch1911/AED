...
public class ProcedimientoPrecioController implements Initializable {
	@FXML
	private HBox view;
	@FXML
	...
	public void onejecutarButtonAction(ActionEvent event) {
		...
		MySQLConnection.ProcedimientoAlmacenado3(nombreUniversidad, precio, TextAreaA);
	}
	...
	public ProcedimientoPrecioController() throws IOException {
