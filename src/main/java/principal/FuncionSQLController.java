...
public class FuncionSQLController implements Initializable{
	@FXML
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		entradaText.textProperty().addListener((o, ov, nv) -> {
			...
			meses.set("Numero de meses: "+SQLConnection.FuncionMesesDif(entradaText.getText()));
	...
	public FuncionSQLController() throws IOException {
